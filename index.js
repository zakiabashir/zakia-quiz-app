...
while (loop) {
    ...
    if (choices.select === "1: => Registration") {
        ...
        if (English.question1 === "c)Children") {
            ...
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${English.ques1}`) +
        ...
        if (English.question2 === "b)Joyful") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 2"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${English.question2}`) +
        ...
        if (English.question3 === "a)Went") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 3"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${English.question3}`) +
        ...
        if (English.question4 === "a)And") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 4"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${English.question4}`) +
        ...
        if (English.question5 === "c)Better") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 5"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${English.question5}`) +
        ...
        if (GeneralKnowledge.question6 === "c)Canberra") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 6"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${GeneralKnowledge.question6}`) +
        ...
        if (GeneralKnowledge.question7 === "b)Nile River") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 7"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${GeneralKnowledge.question7}`) +
        ...
        if (GeneralKnowledge.question8 === "d)H2O") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 8"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${GeneralKnowledge.question8}`) +
        ...
        if (GeneralKnowledge.question9 === "b)Jupiter") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 9"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${GeneralKnowledge.question9}`) +
        ...
        if (GeneralKnowledge.question10 === "a)Fruit") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 10"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${GeneralKnowledge.question10}`) +
        ...
        if (typescript.ques1 === "JavaScript") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 1"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${typescript.ques1}`) +
        ...
        if (typescript.ques2 === "push()") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 2"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${typescript.ques2}`) +
        ...
        if (typescript.ques3 === "It's a superset of JavaScript") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 3"));
            console.log(chalk.yellow.bold(`\t=======================================================`));
            console.log(chalk.red.bold.italic(`\t   YOU CHOOSE: ${typescript.ques3}`) +
        ...
        if (typescript.ques4 === "Any type") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 4"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${typescript.ques4}`) +
        ...
        if (typescript.ques5 === "function") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 5"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${typescript.ques5}`) +
        ...
        if (typescript.ques6 === "===") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 6"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${typescript.ques6}`) +
        ...
        if (typescript.ques7 === "//") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 7"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${typescript.ques7}`) +
                chalk.green.bold.italic(`\n\t    BUT CORRECT ANSWER IS: "//"`));
            console.log(chalk.yellow.bold(`\t===========================================`));
        }
        ...
        if (typescript.ques8 === "Interfaces") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 8"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${typescript.ques8}`) +
        ...
        if (typescript.ques9 === "TypeScript") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 9"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${typescript.ques9}`) +
        ...
        if (typescript.ques10 === "All of the above") {
            ...
            console.log(chalk.blue.bold.italic("\n\t\t       MCQS => 10"));
            console.log(chalk.yellow.bold(`\t===========================================`));
            console.log(chalk.red.bold.italic(`\t        YOU CHOOSE: ${typescript.ques10}`) +
        ...
        console.log(chalk.yellow(`\t THANKS FOR USING THIS ZAKIA-QUIZ-APP-PROJECT PROGRAM CREATOR BY: =>`) + chalk.blue(`\t "ZAKIA BASHIR"`));
        console.log(chalk.green(`\t<==========================================================================>`) + chalk.yellow(`\t<===============>`));
        break;
    }
}
